...
extends MovementModel {
    ...
    public Path getPath() {
        ...
        Coord2 next = this.getRandomWaypoint( this.lastWaypoint.getX(),
    ...
    public Coord2 getInitialLocation() {
        Coord2 c
            = new Coord2( MovementModel.rng.nextDouble() * super.getMaxX(),
    ...
    //========================================================================//
    private Coord2 getRandomWaypoint( double x0, double y0 ) {
        double[] params = null;
        double angle;
        boolean done;
