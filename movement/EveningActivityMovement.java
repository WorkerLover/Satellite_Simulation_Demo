...
public class EveningActivityMovement extends MapBasedMovement 
	...
	private Coord2 startAtLocation;
	...
	public EveningActivityMovement(Settings settings) {
		...
		List<Coord2> meetingSpotLocations = null;
		
		if (shoppingSpotsFile == null) {
			meetingSpotLocations = new LinkedList<Coord2>();
			...
			try {
				meetingSpotLocations = new LinkedList<Coord2>();
				List<Coord2> locationsRead = (new WKTReader()).readPoints(
	 ...
	 */
	public Coord2 getShoppingLocationAndGetReady() {
