...
public class EveningTrip {
	 ...
	 */
	public EveningTrip(int nrOfeveningActivityNodes, Coord2 location) {
	 ...
	 * @param destination
	 */
	public void setDestination(Coord2 destination) {
