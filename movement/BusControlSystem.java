...
public class BusControlSystem {
	 ...
	 */
	public void busHasStopped(int busID, Coord2 busStop, Path nextPath) {
	 ...
	 */
	public List<Coord2> getBusStops() {
		return busStops;
	}
	 ...
	 * @param busStops
	 */
	public void setBusStops(List<Coord2> busStops) {
