...
public class EveningActivityControlSystem {
	...
	private List<Coord2> meetingSpots;
	 ...
	 * @param meetingSpots
	 */
	public void setMeetingSpots(List<Coord2> meetingSpots) {
			...
			if (nextTrips[index] == null) {
				int nrOfEveningMovementNodes = (int)(eveningMovement.
						...
						(double)(eveningMovement.getMaxGroupSize() - 
								...
								rng.nextDouble());
				Coord2 loc = meetingSpots.get(index).clone();
	 ...
	 */
	public Coord2 getMeetingSpotForID(int id) {
