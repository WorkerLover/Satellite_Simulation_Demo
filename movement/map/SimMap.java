...
public class SimMap implements Serializable {
	private Coord2 minBound;
	private Coord2 maxBound;
	...
	private Map<Coord2, MapNode> nodesMap;
	/** offset of map translations */
	private Coord2 offset;
	...
	public SimMap(Map<Coord2, MapNode> nodes) {
		this.offset = new Coord2(0,0);
	 ...
	 */
	public MapNode getNodeByCoord(Coord2 c) {
	...
	private void setBounds() {
		...
		minBound = new Coord2(minX, minY);
		maxBound = new Coord2(maxX, maxY);
	}
