...
public class LinearMovement extends MovementModel {
	...
	private Coord2 startLoc; /** The start location of the line */
	private Coord2 endLoc; /** The start location of the line */
	...
	public LinearMovement(Settings s) {
		...
		this.startLoc = new Coord2(coords[0], coords[1]);
		coords = s.getCsvInts(LINEAR_MOVEMENT_NS + END_LOCATION_S, 2);
		this.endLoc = new Coord2(coords[0], coords[1]);
	 ...
	 */
	private Coord2 calculateLocation(LinearMovement proto, boolean isEven) {
		double dx = 0;
		double dy = 0;
	 ...
	 */
	private Coord2 calculateEndTarget(LinearMovement proto, Coord2 initLoc) {		
	...
	@Override
	public LinearMovement replicateDefault() {
