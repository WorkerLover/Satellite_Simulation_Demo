...
public abstract class MovementModel {
	...
	private Coord coordinate = new Coord(0,0,0);
	 ...
	 */
	public abstract Coord2 getInitialLocation();
	...
	public Coord getSatelliteLocation(double t) {
		...
		coordinate.setLocation(coor[0][0],coor[0][1],coor[0][2]);
	 ...
	 */
	public abstract MovementModel replicateDefault();
	
	/**
	 * Creates a replicate of the movement model.
	 * @return A new movement model with the same settings as this model
	 */
	public abstract MovementModel replicateRandom(boolean multi_orbit);
	
	/**
	 * Creates a replicate of the movement model.And add the order message
	 * @return A new movement model with the same settings as this model
	 */
	public abstract MovementModel replicateRandom(boolean multi_orbit,int order);
	
	/**
	 * Creates a replicate of the movement model.
	 * @return A new movement model with the same settings as this model
	 */
	public abstract MovementModel replicateUserConfig(double[] t);	
