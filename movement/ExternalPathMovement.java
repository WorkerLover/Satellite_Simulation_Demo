...
public class ExternalPathMovement extends MovementModel {
	...
	public Path getPath() {
		...
		if (curPos.getX() != pathStart.x ||
				curPos.getY() != pathStart.y || curPos.getZ()!=pathStart.z) {
			Coord c = new Coord(pathStart.x, pathStart.y, pathStart.z);
