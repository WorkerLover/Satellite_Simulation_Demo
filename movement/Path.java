...
public class Path  {
	...
	public Path() {
		this.nextWpIndex = 0;
		this.coords = new ArrayList<Coord2>();
		this.speeds = new ArrayList<Double>(1);
		this.coords1 = new ArrayList<Coord>();
		this.speeds1 = new ArrayList<Double>(1);
	}
	...
	public Path(Path path) {
		...
		this.coords = new ArrayList<Coord2>((ArrayList<Coord2>)path.coords);
		this.speeds = new ArrayList<Double>((ArrayList<Double>)path.speeds);
		this.coords1 = new ArrayList<Coord>((ArrayList<Coord>)path.coords1);
		this.speeds1 = new ArrayList<Double>((ArrayList<Double>)path.speeds1);
	}
	 ...
	 */
	public List<Coord2> getCoords() {
		return this.coords;
	}
	
	public List<Coord> getCoords1() {
		return this.coords1;
	}
	/**
	 ...
	 */
	public void addWaypoint(Coord2 wp) {
	 ...
	 */
	public void addWaypoint(Coord2 wp, double speed) {
		this.coords.add(wp);
