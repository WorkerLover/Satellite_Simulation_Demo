...
public class ExternalMovementReader {
	 ...
	 */
	public List<Tuple<String, Coord2>> readNextMovements() {
		ArrayList<Tuple<String, Coord2>> moves = 
			new ArrayList<Tuple<String, Coord2>>();
		...
		while (scanner.hasNextLine() && lastTimeStamp == time) {
			...
			moves.add(new Tuple<String, Coord2>(id, new Coord2(x,y)));		
