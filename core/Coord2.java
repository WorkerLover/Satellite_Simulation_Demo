 ...
 * transformations
 */
public class Coord2 implements Cloneable, Comparable<Coord2> {
	private double x;
	private double y;
	private double z = 0;
	 ...
	 */
	public void setLocation(Coord2 c) {
		this.x = c.x;
		this.y = c.y;		
	}
	 ...
	 */
	public double distance(Coord2 other) {
	 ...
	 */
	public double distance2(Coord2 other) {
		double dx = this.x - other.x;
		double dy = this.y - other.y;
	 ...
	 */
	public double angle(Coord2 other) {
		double dx = this.x - other.x;
		double dy = this.y - other.y;
	 ...
	 */
	public boolean equals(Coord2 c) {
		if (c == this) {
			return true;
		}
		else {
	...
	/**
	 * Returns the a 2-D coordinate from a 3-D coordinate;
	 * copy the x,y of 3-D coordinate to the 2-D coordinate
	 * @param other The other coordinate
	 * @return 2-D coordinate
	 */
	public Coord2 convert(Coord other) {
		Coord2 coo = new Coord2(0,0);
		coo.setLocation(other.getX(), other.getY());
		return coo;
