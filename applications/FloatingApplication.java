...
public class FloatingApplication extends Application {
    ...
    private Coord   anchor        = new Coord (0,0,0);
    
    private Coord   anchor_max;
    private Coord   anchor_gran   = new Coord (1, 1, 1);
	...
	public FloatingApplication(Settings s) {
		...
		this.anchor_max = new Coord(worldSize[0], worldSize[1],0.0);
		...
		if (s.contains(FLOATING_ANCHOR)) {
			...
			anchor.setLocation(destination[0], destination[1],0.0);
		...
		if (s.contains(FLOATING_ANCHOR_MAX)) {
			...
			anchor_max.setLocation(destination[0], destination[1],0.0);
		...
		if (s.contains(FLOATING_ANCHOR_GRAN)) {
			...
			anchor_gran.setLocation(destination[0], destination[1],0.0);
	...
	this.anchor.setLocation (c.getX(), c.getY(),0.0);
    }
	...
	this.anchor.setLocation (x, this.anchor.getY(),0.0);
    }
	...
	this.anchor.setLocation (this.anchor.getX(), y,0.0);
    }
